...
public class RoomDBHelper extends SQLiteOpenHelper {
    ...
    public static final String DB_NAME = "room_manager.db";
    public static final int VERSION = 1;    //构造方法
    public RoomDBHelper(Context context, String name, CursorFactory factory, int version)
    {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("create table "
                + TableContanst.ROOM_TABLE                 + "(_id Integer primary key AUTOINCREMENT,"
